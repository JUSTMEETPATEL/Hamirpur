...
export default function AboutNITH() {
  return (
    <section id="about-nith" className="py-16 bg-gray-100">
      ...
      <h2 className="text-3xl md:text-4xl font-bold mb-20 text-center">About NIT Hamirpur</h2>
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
        <Image
          src="/pics/nit gate.jpg"
        ...
        <div>
        <p className="text-lg text-gray-800 mb-4 leading-loose text-justify">
